...
<<<<<<<< HEAD:vignettes/Setting_up_MCMC.Rmd
output: html_document
========
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{SettingUpMCMC}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
>>>>>>>> 1-update-vignette-documentation:vignettes/SettingUpMCMC.Rmd
---
...
```{r evolutionary-parameter-traces, eval=F}
...
```{r evolutionary-parameter-hists, eval=F}
StructCoalescent_log <- read.csv('./StructCoalescent.log',
                                 header=TRUE)
layout(matrix(1:d^2, d, d))
for (col_id in 1:d){
