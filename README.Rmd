...
This is a basic example of usage. First, we generate a heterochronous dated structured phylogenetic tree with $n=10$ leaves sampled between 2015 and 2020 from $d=3$ demes.
...
We can run $N=100,000$ MCMC algorithm taking this dated structured phylogeny as input with default prior distributions as follows (NOT RUN):
